...
public class Channel2RecyclerViewAdapter extends RecyclerViewAdapterHelper<Channel2Bean.DataBean> {
    public Channel2RecyclerViewAdapter(Context context, List<Channel2Bean.DataBean> list) {
        super(context, list);
    }
    ...
    public void onBindMyViewHolder(RecyclerView.ViewHolder holder, int position) {
        Channel2Bean.DataBean dataBean = mList.get(position);
