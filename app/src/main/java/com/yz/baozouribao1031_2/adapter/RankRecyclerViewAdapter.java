...
public class RankRecyclerViewAdapter extends
        RecyclerViewAdapterHelper<RankBean.DataBean> {
    public RankRecyclerViewAdapter(Context context, List<RankBean.DataBean>
            list) {
        super(context, list);
    }
    ...
    public void onBindMyViewHolder(RecyclerView.ViewHolder holder, int position) {
        RankBean.DataBean dataBean = mList.get(position);
