...
public class RankVoteFragment extends android.support.v4.app.Fragment {

    private Context mContext = null;
    private RecyclerView rankVoteRecycler;
    ...
    private void initView(View view) {
        rankVoteRecycler = (RecyclerView) view.findViewById(R.id.recyclerView_fragment_only);
        LinearLayoutManager layoutManager = new LinearLayoutManager(mContext, LinearLayoutManager
                .VERTICAL, false);
        rankVoteRecycler.setLayoutManager(layoutManager);
        rankVoteRecycler.setHasFixedSize(true);
        rankVoteRecycler.addItemDecoration(new SpacesItemDecoration(15));
    }
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            RankRecyclerViewAdapter rankAdapter = new RankRecyclerViewAdapter
                                    (mContext, mList);
                            rankVoteRecycler.setAdapter(rankAdapter);
                        }
                    });
                } catch (IOException e) {
                    e.printStackTrace();
